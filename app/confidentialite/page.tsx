...
const SECTIONS: Array<{ title: string; paragraphs: string[] }> = [
  {
    ...
    paragraphs: [
      `Le site www.festivalyuna.com est édité par ${ORGANIZER.name}, organisateur du YUNA Festival 2026 au Terrain de Midombo, Cotonou (Bénin). Pour toute question relative à tes données personnelles, écris-nous à ${SITE_CONTACT.email}.`,
    ],
  },
  {
