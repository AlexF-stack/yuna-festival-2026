...
const SECTIONS: Array<{ title: string; paragraphs: string[] }> = [
  {
    ...
    paragraphs: [
      `Le site yunafestival.com est édité par ${ORGANIZER.name}, organisateur du YUNA Festival 2026 à Cotonou (Bénin). Pour toute question relative à tes données personnelles, écris-nous à ${SITE_CONTACT.email}.`,
    ],
  },
  {
