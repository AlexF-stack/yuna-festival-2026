...
export function ArtistCard({ artist, index }: ArtistCardProps) {
  ...
  if (isHeadliner) {
    return (
      <motion.article
        ...
        className="relative col-span-full overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-bleu to-bleu-fonce p-8 text-papier shadow-[0_24px_60px_rgba(0,90,140,0.22)] min-[760px]:p-12"
      >
  ...
  return (
    <motion.article
      ...
      className="group rounded-2xl border border-bleu/10 bg-papier p-6 shadow-[0_10px_30px_rgba(0,90,140,0.05)] transition-[transform,box-shadow,border-color] duration-[250ms] ease-yuna hover:-translate-y-1 hover:border-bleu/25 hover:shadow-[0_18px_40px_rgba(0,90,140,0.1)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
    >
