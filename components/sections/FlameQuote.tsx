...
/**
 * Bloc Mission — typo en relief + un seul zoom doux (budget animation design system).
 */
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-8 text-center min-[480px]:px-12">
          ...
          <footer className="mt-6 flex flex-wrap items-center justify-center gap-3 font-mono text-[0.72rem] font-bold uppercase tracking-[0.2em] text-charbon/80">
            <span className="rounded-full bg-papier px-3 py-1 shadow-[0_8px_24px_rgba(0,119,187,0.08)]">
              {FESTIVAL.brand}
            </span>
            <span className="text-feu">•</span>
            <span
              className="rounded-full bg-white/90 px-3 py-1 text-feu shadow-[0_8px_24px_rgba(255,102,0,0.08)]"
              style={{
                textShadow:
                  "0 1px 0 rgba(255,255,255,0.9), 0 3px 10px rgba(255,102,0,0.18)",
              }}
            >
              {FESTIVAL.theme}
            </span>
